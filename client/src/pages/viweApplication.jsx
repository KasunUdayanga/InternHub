...
const ViewApplication = () => {
  ...
  if (!applicants.length) return <Loading />;
      ...
      <table className="w-full max-w-4xl bg-white border border-gray-200 max-sm:text-sm">
        <thead>
          <tr className="border-b">
            ...
            <th className="py-2 px-4 text-left max-sm:hidden">Intern Title</th>
        ...
        <tbody>
          {applicants
            .filter((application) => application.internId && application.userId)
                  ...
                  {application.status === "Pending" ? (
                    <div className="relative inline-block text-left group">
                      ...
                      <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 bg-white border border-gray-200 rounded shadow group-hover:block">
                        <button
                          onClick={() =>
                            changeJobApplicationStatus(application._id, "Accepted")
                          }
                        ...
                        <button
                          onClick={() =>
                            changeJobApplicationStatus(application._id, "Rejected")
                          }
