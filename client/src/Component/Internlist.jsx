...
const Internlist = () => {
  ...
  useEffect(()=>{
    ...
    const newFilteredJobs = jobs.slice().reverse().filter(job=>matchesCategory(job) && matchesLocation(job) && matchesTitles(job) && matchesSearchLocations(job))
    ...
    <div className="container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8">
      ...
      <section className="text-gray-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-2">
          {filteredJobs.slice((currentPage-1)*6,currentPage*6).map((intern, index) => (
